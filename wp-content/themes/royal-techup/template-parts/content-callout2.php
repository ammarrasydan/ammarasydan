...
?>
 ...
 <section class="cta-7 ptb-70 busi-corp" style="background-image:url(<?php if($techup_co2_image) { echo esc_url($techup_co2_image); } else { echo esc_url(get_callout_image()); } ?>)">>
	<div class="container">
		<div class="row">
			<div class="col-md-9">
