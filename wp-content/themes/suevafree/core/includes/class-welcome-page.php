			...
			<div class="getting-started-top-wrap clearfix">
				...
				<div class="theme-steps-list">
					...
					<div class="theme-steps">
						...
						<a target="_blank" class="button button-primary" href="<?php echo esc_url('http://demo.themeinprogress.com/suevafree/suevafree-documentation/'); ?>"><?php echo esc_html__('Go to Docs', 'suevafree'); ?></a>
					</div>
