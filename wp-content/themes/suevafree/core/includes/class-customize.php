	...
	class Suevafree_Customize_Info_Control extends WP_Customize_Control {
		...
		public function render_content() { ?>
            ...
            <div class="inside">
                ...
                <h2><?php esc_html_e('Premium features','suevafree');?></h2>
                <p><?php esc_html_e('Upgrade to the premium version of Sueva, to enable all features.','suevafree');?></p>
                ...
                <ul class="features-list">
                	...
                	<li><span class="dashicon dashicons dashicons-yes"></span><?php esc_html_e('60 percent discount on subscription renewal','suevafree');?></li>
                	<li><span class="dashicon dashicons dashicons-yes"></span><?php esc_html_e('7 days money back guarantee','suevafree');?></li>
